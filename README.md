...
- **🆕 Resource Monitoring** - กราฟ CPU/RAM/Disk แบบ realtime
- **🆕 Auto SSL** - ขอและต่ออายุ Let's Encrypt อัตโนมัติ
...
mControlPanel มีระบบ monitoring แบบ realtime:

### Dashboard Features
- **กราฟ CPU** - แสดงการใช้งาน CPU แบบ realtime
- **กราฟ Memory** - แสดงการใช้งาน RAM
- **กราฟ Disk** - แสดงพื้นที่ใช้งาน
- **Progress Rings** - แสดงเปอร์เซ็นต์แบบวงกลม
- **ประวัติ** - ดูย้อนหลังได้ 5 นาที, 15 นาที, 30 นาที, 1 ชั่วโมง

### API Endpoints

| Endpoint | ใช้สำหรับ |
|----------|----------|
| `GET /api/resource/realtime` | ดึงข้อมูล CPU/RAM/Disk ปัจจุบัน |
| `GET /api/resource/history?period=1h` | ดึงประวัติ (5m, 15m, 30m, 1h) |
...
ขอและจัดการ SSL Certificate อัตโนมัติ:

### วิธีใช้งาน
1. ไปที่เมนู **SSL Certificates**
2. เลือก Domain ที่ต้องการ
3. ใส่ Email สำหรับรับการแจ้งเตือน
4. คลิก **ขอ Certificate**

### ข้อกำหนด
- Domain ต้อง point มาที่ server นี้แล้ว
- Port 80 ต้องเปิดใช้งาน
- ต้องติดตั้ง certbot บน server
...
### Auto Renew
ระบบจะตรวจสอบและต่ออายุ Certificate อัตโนมัติทุกวัน
